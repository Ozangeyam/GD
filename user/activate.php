...
<body>
	...
	if ($query === true) {
		...
		$to = $user['email'];
        $name = $user['name'];
        // $name = "Galaxy Digital Holdings Support";
        $subject = "Welcome!";
        $body = "<!DOCTYPE html>
          ...
          <table role='presentation' style='width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;'>
            ...
            <tr>
              <td style='padding:30px;background-color:#ffffff;'>
                ...
                <p style='margin:0;'><b>Hi $name,</b><br>Congratulations for a successful comfirmation of your Galaxy Digital account, just a few more steps to activate your account and start earning.</p>
                <p>Do you know you can earn up to 5-25% profit from your prefered investment plan in Galaxy Digital in 4-21 days from the comfort of your home?</p>
                <p>Galaxy Digital team of professionals have carefully mapped out investment plans with the use of analytical tools such as artificial intelligence
...
(herbal and supplements),government agencies and information technology, Galaxy Digital provides its investors with quality asset and financial services.</p>
<p>TAKE THE TOUR by simply clicking on <a href='www.galaxydigital.trade'>www.galaxydigital.trade</a> to login to your account and explore Galaxy Digital.</p>
...
<p>Note: Be informed that transaction of bitcoin attracts higher charges than other crypto by your transaction network, this is not from Galaxy Digital.</p>
<p>For more information,contact Galaxy Digital costumer care 24hrs live chat on the website or,
send us an email at support@galaxydigital.trade.</p>
<p>we hope to meet you at our next Galaxy Digital convention.</p>
<p>Happy Investing!!</p>
              </td>
            </tr>
