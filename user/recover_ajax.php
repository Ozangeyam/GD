...
<body style='margin:0;padding:0;word-spacing:normal;background-color:#939297;'>
  <div role='article' aria-roledescription='email' lang='en' style='text-size-adjust:100%;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#fff;'>
          ...
          <table role='presentation' style='width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;'>
            ...
            <tr>
              <td style='padding:30px;background-color:#ffffff;'>
                <h1 style='margin-top:0;margin-bottom:16px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;'>Recovery Code!</h1>
                <p style='margin:0;'><b>Dear $name,</b><br> Your Recovery Code is <h1>$pin</h1></p>
                <p>Thank you for choosing Galaxy Digital</p>
                <p>Best Regards!</p>
              </td>
            </tr>
	...
	// global $link;
	if ($pin != null) {
		if (check_duplicate("users", "email", $email)) {
		  $send_mail = send_mail($email, $name, $subject, $body);
      if ($send_mail) {
			   echo json_encode(array('pin' => $pin, 'name' => $name, 'success' => 1));
