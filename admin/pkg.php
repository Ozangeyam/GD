                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <form action="" method="get">
                                        <input name="variant" type="text" class="form-control" style="max-width: 250px; display: inline; height: 46px;" placeholder="Search Amount/Plan...">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_GET['submit']) && !empty($_GET['variant'])) {
                                                    ...
                                                    $all_Inv = fetch_all_investments_match($variant); 
                                                }else{
