...
if (isset($_GET['action'])) {
    if ($_GET['action'] === "success") {
      $i = $_GET['i'];
        echo "<script>swal('Sent!', 'Email Delivered Successfully for $i Users!', 'success');</script>";
                        ...
                        <div class="col-lg-6">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <?php
                                    if (isset($_GET['submit']) && !empty($_GET['subject']) && !empty($_GET['body'])) {
                      ...
                      if($all_Users){
                          ...
                          foreach ($all_Users as $user) {
                                      ...
                                      $email = $user['email'];
                                        ...
                                        $mail = send_mail($email, $name, $_GET['subject'], $body);
                                        // var_dump($post);
                                        if ($mail === true) {
                                            $i++;
                                        }
                            ...
                            if ($i > 0) {
                                header("Location: email?action=success&i=$i"); 
                                exit();
                            }else{
