          ...
          <table role='presentation' style='width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;'>
            ...
            <tr>
              <td style='padding:30px;background-color:#ffffff;'>
                ...
                <p>Thank you for choosing $site_title.</p>
                <p>Best Regards!</p>
              </td>
            </tr>
                ...
                <table role='presentation' style='width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;'>
                  ...
                  <tr>
                    <td style='padding:30px;background-color:#ffffff;'>
                      ...
                      <p><b>Value Date:</b> $date</p>
                      <p><b>Time of Transaction:</b> $time</p>
                      <p>The privacy and security of your account details is important to us. if you did not make this transaction, kindly contact our 24 hours live support on the website or send us an email at <a href='mailto:$support_email'>$support_email</a> for assistance.</p>
                      <p>Note that $site_title will never request for the password to your account.</p>
