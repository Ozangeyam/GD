		          ...
		          <table role='presentation' style='width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;'>
		            ...
		            <tr>
		              <td style='padding:30px;background-color:#ffffff;'>
		                ...
		                <p>The Privacy and Security of your account details is very important to us. If you did not make this transaction, kindly contact skyro customer service 24 hours live support on the website or send us an email at <a href='mailto:support@galaxydigital.trade'>support@galaxydigital.trade</a> for assistance.</p>
		                <p>Note that Galaxy Digital Holdings will never request the password of your account for any reason.</p>
		                <p>Best Regards!</p>
		              </td>
		            </tr>
		            ...
		            <tr>
		              <td style='padding:30px;text-align:center;font-size:12px;background-color:#404040;color:#cccccc;'>
		                ...
		                <p style='margin:0;font-size:14px;line-height:20px;'>&reg; $site_title, 300 Vesey Street, New York, NY 10282 United States</p>
		              </td>
		            </tr>
		          </table>
		          <!--[if mso]>
