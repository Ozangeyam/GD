                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <form action="" method="get">
                                        <input name="variant" type="text" class="form-control" style="max-width: 250px; display: inline; height: 46px;" placeholder="Search Amount/Trx ID...">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_GET['submit']) && !empty($_GET['variant'])) {
                                                    ...
                                                    $all_Pending = fetch_all_pending_match($variant); 
                                                }else{
                                            	...
                                            	if($all_Pending){
                                            		...
                                            		foreach ($all_Pending as $pend) {
                                            			$i++;
                                                        if (!empty($pend['trans_id'])) {
                                                            $trans_id = $pend['trans_id'];
                                                        }else{
                                                            $trans_id = "Wdr/pending/$i";
                                                        }
